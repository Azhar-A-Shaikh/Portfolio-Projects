# This code will pull 1 data from the COIN EXCHANGE API to get us that days Forex Exchange rates. 

# To run and get todays Forex exchange data
# python3 main.py --config '{"app_id" : "251803cdbb994fe2813635578dacbd0a","s3_out_location":"s3://py-sparkapi/api_response/","s3_error_out_location":"s3://py-sparkapi/api_response/"}'# To run for historical date

# To run and get historical Forex exchnage data. 
# python3 main.py --run_ts '1999-01-06' --config '{"app_id" : "251803cdbb994fe2813635578dacbd0a","s3_out_location":"s3://py-sparkapi/api_response/","s3_error_out_location":"s3://py-sparkapi/api_response/"}'
